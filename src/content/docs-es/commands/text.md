...
El comando `text` coloca una etiqueta de texto multilínea. Tras hacer clic en una posición del lienzo, se abre un editor emergente donde puedes escribir contenido, aplicar negrita/cursiva/tachado, cambiar fuentes y alturas, e insertar saltos de línea. Pulsa **Escape** para confirmar y cerrar el editor.

Consulta la página del [Editor de Texto](../interface/text-editor) para la referencia completa del editor.
