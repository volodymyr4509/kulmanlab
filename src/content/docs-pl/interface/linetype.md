---
title: Selektor typów linii — Kontrolowanie wzorców przerywanych
...
Aby zmienić typ linii istniejących elementów, zaznacz je i edytuj pole **Typ linii** w panelu właściwości, lub użyj [Match Properties](../../commands/match-properties/), aby skopiować go z innego elementu.
