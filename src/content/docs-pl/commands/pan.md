...
## Przeciągnięcie środkowym przyciskiem myszy — panoramowanie bez aktywowania polecenia

Najszybszy sposób panoramowania: **przytrzymaj środkowy przycisk myszy i przeciągnij** w dowolnym momencie, nawet gdy inne polecenie jest aktywne. Nie potrzeba aktywować polecenia. Zwolnienie środkowego przycisku powraca do poprzedniego stanu.

## Panoramuj a sterowanie powiększeniem

| Akcja | Efekt | Wymaga trybu Panoramuj? |
|--------|--------|-------------------|
| Przeciągnięcie lewym przyciskiem (tryb Panoramuj) | Przesuwa widok | Tak |
...
| Klawisz | Akcja |
|---------|-------|
| `Escape` | Wyjdź z trybu panoramowania |
