---
title: Tệp — Bảng Tệp Gần Đây trong KulmanLab CAD
...
- [Nhập](../import/) — tải bản vẽ từ hệ thống tệp vào bộ nhớ trình duyệt
- [Xuất](../export/) — tải bản vẽ xuống hệ thống tệp
- [Tệp Mới](../new-file/) — bắt đầu bản vẽ trắng (cũng được lưu tự động)
