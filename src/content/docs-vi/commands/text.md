...
Lệnh `text` đặt nhãn văn bản nhiều dòng. Sau khi bạn nhấp vị trí trên canvas, trình soạn thảo popup mở nơi bạn có thể gõ nội dung, áp dụng in đậm/in nghiêng/gạch ngang, thay đổi phông chữ và chiều cao, và chèn ngắt dòng. Nhấn **Escape** để xác nhận và đóng trình soạn thảo.

Xem trang [Trình Soạn Thảo Văn Bản](../interface/text-editor) để tham khảo đầy đủ trình soạn thảo.
