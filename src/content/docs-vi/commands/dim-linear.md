---
title: Lệnh Dimension Linear — Kích Thước Ngang và Dọc
...
Lệnh `dimlinear` đặt kích thước ngang hoặc dọc giữa hai điểm gốc gióng. Đường kích thước luôn chạy hoàn toàn ngang hoặc dọc — không thể đặt theo góc tùy ý. Dùng [Dimension Aligned](../dim-aligned/) khi cần kích thước song song với đường chéo.
...
Để thêm các kích thước tiếp tục từ đường gióng cuối cùng, dùng [Dimension Continue](../dim-continue/) ngay sau khi đặt kích thước này.
