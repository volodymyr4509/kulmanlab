---
title: Lệnh Vừa Khung — Đóng Khung Tất Cả Thực Thể Trong Khung Nhìn Bằng Một Nhấp trong KulmanLab CAD
...
**Nhấp đúp nút chuột giữa** kích hoạt cùng thao tác Vừa Khung bất kỳ lúc nào mà không cần kích hoạt lệnh.
...
## Vừa Khung vs điều khiển phóng to thủ công

| | Vừa Khung | Phóng To / Thu Nhỏ | Bánh xe cuộn |
|---|------|------|------|
