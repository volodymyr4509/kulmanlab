...
| Khả dụng khi | Ít nhất một hành động được ghi tồn tại | Ít nhất một Undo đã được thực hiện và không có hành động mới |
| Bị xóa bởi | Không có gì — lịch sử tích lũy đến giới hạn 20 bước | Bất kỳ hành động vẽ mới nào |

Dùng [Redo](../redo/) để áp dụng lại hành động đã hoàn tác. Các nút thanh công cụ bị làm mờ khi hướng tương ứng không khả dụng.
