---
title: Lệnh Hình Chữ Nhật — Vẽ Hình Chữ Nhật Căn Chỉnh Trục trong KulmanLab CAD
...
|------|--------------------------|
| [Di Chuyển](../move/) | Dịch chuyển tất cả bốn đỉnh |
| [Sao Chép](../copy/) | Tạo hình chữ nhật giống hệt tại vị trí mới |
| [Xoay](../rotate/) | Xoay tất cả bốn đỉnh quanh điểm cơ sở |
| [Đối Xứng](../mirror/) | Phản chiếu tất cả bốn đỉnh qua trục |
| [Tỉ Lệ](../scale/) | Chia tỉ lệ tất cả bốn đỉnh đồng đều |
| [Offset](../offset/) | Tạo hình chữ nhật song song (thu nhỏ hoặc mở rộng) |
| [Xóa](../delete/) | Xóa hình chữ nhật |
