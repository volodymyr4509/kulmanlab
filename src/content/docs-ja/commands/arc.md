...
| コマンド | 円弧への影響 |
|---------|------------|
| [Move](../move/) | 中心を移動。半径と角度は変わらない |
| [Copy](../copy/) | 新しい位置に同一の円弧を作成 |
| [Rotate](../rotate/) | 中心を回転し、スタート/エンド角を回転量だけシフト |
| [Mirror](../mirror/) | 中心を反射し、鏡軸に対してスタート/エンド角を反転 |
| [Scale](../scale/) | 中心位置を拡縮し、半径に係数を乗じる |
| [Offset](../offset/) | 同じ角度範囲を保持しながら、大きいまたは小さい半径の同心円弧を作成 |
| [Delete](../delete/) | 円弧を削除 |
