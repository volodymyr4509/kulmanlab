  ...
  en: [
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Are cookies used?', a: 'Cookies are used for Google Analytics, which collects anonymous usage metrics (page views, session counts).' },
      ],
    },
  ],
  ...
  de: [
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Werden Cookies verwendet?', a: 'Cookies werden für Google Analytics verwendet, das anonyme Nutzungsmetriken erfasst (Seitenaufrufe, Sitzungsanzahl).' },
      ],
    },
  ],
  ...
  es: [
    ...
    },
    {
      ...
      items: [
        ...
        { q: '¿Se usan cookies?', a: 'Se usan cookies para Google Analytics, que recopila métricas de uso anónimas (vistas de página, número de sesiones).' },
      ],
    },
  ],
  ...
  fr: [
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Des cookies sont-ils utilisés ?', a: "Des cookies sont utilisés pour Google Analytics, qui collecte des statistiques d'utilisation anonymes (pages vues, nombre de sessions)." },
      ],
    },
  ],
  ...
  it: [
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Vengono usati cookie?', a: "I cookie sono usati per Google Analytics, che raccoglie metriche d'uso anonime (visualizzazioni di pagina, numero di sessioni)." },
      ],
    },
  ],
  ...
  pt: [
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'São usados cookies?', a: 'Cookies são usados para o Google Analytics, que coleta métricas de uso anônimas (visualizações de página, contagem de sessões).' },
      ],
    },
  ],
  ...
  zh: [
    ...
    },
    {
      ...
      items: [
        ...
        { q: '使用 Cookie 吗？', a: '网站使用 Cookie 用于 Google Analytics，以收集匿名使用指标（页面浏览量、会话数）。' },
      ],
    },
  ],
  ...
  tr: [
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Çerez kullanılıyor mu?', a: 'Çerezler, anonim kullanım metriklerini (sayfa görüntüleme, oturum sayısı) toplayan Google Analytics için kullanılır.' },
      ],
    },
  ],
  ...
  uk: [
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Чи використовуються cookie?', a: 'Cookie використовуються для Google Analytics, який збирає анонімні метрики використання (перегляди сторінок, кількість сесій).' },
      ],
    },
  ],
  ...
  hi: [
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'क्या कुकी का उपयोग होता है?', a: 'कुकी Google Analytics के लिए उपयोग होती हैं, जो अनाम उपयोग मेट्रिक्स (पेज व्यू, सत्र संख्या) एकत्र करता है।' },
      ],
    },
  ],
  ...
  ar: [
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'هل تُستخدم ملفات تعريف الارتباط؟', a: 'تُستخدم ملفات تعريف الارتباط لـ Google Analytics الذي يجمع مقاييس استخدام مجهولة الهوية (مشاهدات الصفحات، عدد الجلسات).' },
      ],
    },
  ],
  ...
  id: [
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Apakah cookie digunakan?', a: 'Cookie digunakan untuk Google Analytics, yang mengumpulkan metrik penggunaan anonim (tayangan halaman, jumlah sesi).' },
      ],
    },
  ],
  ja: [
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Cookieは使用されていますか？', a: 'CookieはGoogle Analyticsに使用され、匿名の利用統計（ページビュー、セッション数）を収集します。' },
      ],
    },
  ],
  ...
  pl: [
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Czy używane są pliki cookie?', a: 'Pliki cookie są używane przez Google Analytics, który zbiera anonimowe metryki użytkowania (odsłony stron, liczba sesji).' },
      ],
    },
  ],
  ...
  ko: [
    ...
    },
    {
      ...
      items: [
        ...
        { q: '쿠키가 사용되나요?', a: '쿠키는 익명 사용 지표(페이지 조회수, 세션 수)를 수집하는 Google Analytics에 사용됩니다.' },
      ],
    },
  ],
  ...
  vi: [
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Cookie có được sử dụng không?', a: 'Cookie được sử dụng cho Google Analytics, thu thập số liệu sử dụng ẩn danh (lượt xem trang, số phiên).' },
      ],
    },
  ],
  th: [
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'มีการใช้คุกกี้ไหม?', a: 'มีการใช้คุกกี้สำหรับ Google Analytics ซึ่งเก็บสถิติการใช้งานแบบไม่ระบุตัวตน (จำนวนการเข้าชมหน้า จำนวนเซสชัน)' },
      ],
    },
  ],
  ms: [
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Adakah kuki digunakan?', a: 'Kuki digunakan untuk Google Analytics, yang mengumpul metrik penggunaan tanpa nama (paparan halaman, kiraan sesi).' },
      ],
    },
  ],
  ...
  bn: [
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'কি কুকি ব্যবহার করা হয়?', a: 'কুকি Google Analytics-এর জন্য ব্যবহৃত হয়, যা বেনামী ব্যবহারের মেট্রিক্স (পেজ ভিউ, সেশন সংখ্যা) সংগ্রহ করে।' },
      ],
    },
  ],
  ...
  sw: [
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Je, kuki zinatumika?', a: 'Kuki zinatumika kwa Google Analytics, inayokusanya vipimo vya matumizi visivyo na utambulisho (kurasa zilizotazamwa, idadi ya vikao).' },
      ],
    },
  ],
  ...
  ur: [
    {
      headingKey: 'faq.section.start',
      items: [
        { q: 'کیا KulmanLab واقعی مفت ہے؟', a: 'ہاں — مکمل طور پر مفت۔ کوئی سبسکرپشن نہیں، کوئی کریڈٹ کارڈ نہیں، کوئی پوشیدہ پلان نہیں۔ مکمل فیچر سیٹ بغیر کسی حد کے سب کے لیے دستیاب ہے۔' },
        { q: 'کیا مجھے اکاؤنٹ بنانا ہوگا؟', a: 'نہیں۔ کوئی لاگ ان نہیں، کوئی سائن اپ نہیں، کوئی ای میل درکار نہیں۔ ایپ کھولیں اور فوراً ڈرائنگ شروع کریں۔' },
        { q: 'کون سے براؤزرز سپورٹ کیے جاتے ہیں؟', a: 'کوئی بھی جدید ڈیسک ٹاپ براؤزر — Chrome، Firefox، Safari اور Edge سب کام کرتے ہیں۔ KulmanLab صرف ڈیسک ٹاپ کے لیے ہے؛ موبائل اور ٹیبلیٹ فی الحال سپورٹ نہیں ہیں۔' },
        { q: 'کیا یہ آف لائن کام کرتا ہے؟', a: 'ہاں۔ پہلی بار لوڈ ہونے کے بعد ایپ کیش ہو جاتی ہے اور انٹرنیٹ کنکشن کے بغیر مکمل طور پر چلتی ہے۔ آپ کی ڈرائنگز مقامی طور پر محفوظ ہوتی ہیں۔' },
      ],
    },
    {
      headingKey: 'faq.section.files',
    ...
    },
    {
      headingKey: 'faq.section.features',
      items: [
        { q: 'کیا اس میں کمانڈ ٹرمینل ہے؟', a: 'ہاں۔ کمانڈز براہ راست ٹائپ کریں — LINE، CIRCLE، MOVE، TRIM اور 50 سے زائد دیگر۔ ٹرمینل تاریخ (تیر والے کیز)، آٹو کمپلیٹ (Tab) اور صحیح عددی ان پٹ سپورٹ کرتا ہے۔' },
        { q: 'کیا پرت کی سپورٹ ہے؟', a: 'مکمل پرت انتظام: بنائیں، نام بدلیں، منجمد کریں، مقفل کریں اور پرتوں کو الگ کریں۔ فی پرت رنگ، لائن کی قسم اور لائن کا وزن ترتیب دیں۔ تمام پرت ڈیٹا DXF برآمد میں محفوظ رہتا ہے۔' },
        { q: 'کون سی پیمائش کی اقسام دستیاب ہیں؟', a: 'خطی، ہم آہنگ، رداس، قطر، زاویہ اور مسلسل پیمائشیں۔ سبھی معیاری DXF DIMENSION اکائیوں کے طور پر محفوظ ہیں جو دوسرے DXF قابل CAD ٹولز کے ساتھ مطابقت رکھتی ہیں۔' },
        { q: 'کیا میں گرپس سے جیومیٹری ترمیم کر سکتا ہوں؟', a: 'ہاں۔ کسی بھی اکائی کو منتخب کریں تاکہ اہم نکات پر گرپ ہینڈلز ظاہر ہوں — اختتامی نکات، درمیانی نکات، مراکز، آرک کے سرے۔ براہ راست کینوس پر دوبارہ شکل دینے کے لیے کھینچیں۔' },
        { q: 'کیا ریئل ٹائم تعاون سپورٹ ہے؟', a: 'فی الحال نہیں۔ KulmanLab ایک واحد صارف ٹول ہے اور ڈرائنگز مقامی رہتی ہیں۔ کلاؤڈ سنک اور تعاون فی الحال دائرہ کار سے باہر ہے۔' },
      ],
    },
    {
      headingKey: 'faq.section.compat',
      items: [
        { q: 'کیا KulmanLab DXF فائلیں دوسرے CAD سافٹ ویئر کے ساتھ مطابقت رکھتی ہیں؟', a: 'ہاں۔ KulmanLab AC1032 DXF پڑھتا اور لکھتا ہے — ایک وسیع پیمانے پر سپورٹ شدہ ورژن۔ فائلیں LibreCAD، QCAD، BricsCAD، FreeCAD اور کسی بھی DXF قابل ٹول میں صحیح کھلتی ہیں۔' },
        { q: 'DXF اور DWG میں کیا فرق ہے؟', a: 'DXF ایک کھلا، متن پر مبنی تبادلہ فارمیٹ ہے جو باہمی عمل کے لیے بنایا گیا ہے۔ DWG ایک ملکیتی بائنری فارمیٹ ہے۔ KulmanLab DXF استعمال کرتا ہے جسے تقریباً ہر CAD ٹول پڑھ سکتا ہے۔' },
        { q: 'کیا KulmanLab میرے ڈیسک ٹاپ CAD سافٹ ویئر کی جگہ لے سکتا ہے؟', a: '2D ڈرافٹنگ کے لیے — ہاں۔ KulmanLab میں مکمل کمانڈ ٹرمینل، پرتیں، اسنیپنگ، پیمائشیں، گرپ ایڈیٹنگ اور DXF مطابقت ہے۔ یہ 3D، بلاکس/xrefs یا پیرامیٹرک قیود سپورٹ نہیں کرتا۔' },
      ],
    },
    {
      headingKey: 'faq.section.privacy',
      items: [
        ...
        { q: 'کیا کوکیز استعمال ہوتی ہیں؟', a: 'کوکیز Google Analytics کے لیے استعمال ہوتی ہیں، جو گمنام استعمال کے اعدادوشمار (صفحہ ویوز، سیشن کی تعداد) جمع کرتا ہے۔' },
      ],
    },
  ],
  ...
  el: [
    {
      headingKey: 'faq.section.start',
      items: [
        { q: 'Είναι το KulmanLab πραγματικά δωρεάν;', a: 'Ναι — εντελώς δωρεάν. Χωρίς συνδρομή, χωρίς πιστωτική κάρτα, χωρίς κρυφό πλάνο. Το πλήρες σύνολο λειτουργιών είναι διαθέσιμο σε όλους χωρίς περιορισμούς.' },
        { q: 'Χρειάζεται να δημιουργήσω λογαριασμό;', a: 'Όχι. Δεν υπάρχει σύνδεση, εγγραφή ή email. Ανοίξτε την εφαρμογή και ξεκινήστε αμέσως να σχεδιάζετε.' },
        { q: 'Ποιοι browsers υποστηρίζονται;', a: 'Οποιοσδήποτε σύγχρονος browser επιφάνειας εργασίας — Chrome, Firefox, Safari και Edge λειτουργούν όλα. Το KulmanLab είναι μόνο για επιφάνεια εργασίας· mobile και tablet δεν υποστηρίζονται προς το παρόν.' },
        { q: 'Λειτουργεί offline;', a: 'Ναι. Μετά την πρώτη φόρτωση η εφαρμογή αποθηκεύεται στην κρυφή μνήμη και τρέχει εντελώς χωρίς σύνδεση στο διαδίκτυο. Τα σχέδιά σας αποθηκεύονται τοπικά.' },
      ],
    },
    {
      headingKey: 'faq.section.files',
    ...
    },
    {
      headingKey: 'faq.section.features',
      items: [
        { q: 'Υπάρχει terminal εντολών;', a: 'Ναι. Πληκτρολογήστε εντολές απευθείας — LINE, CIRCLE, MOVE, TRIM και 50+ άλλες. Το terminal υποστηρίζει ιστορικό (βελάκια), αυτόματη συμπλήρωση (Tab) και ακριβή αριθμητική εισαγωγή.' },
        { q: 'Υπάρχει υποστήριξη επιπέδων;', a: 'Πλήρης διαχείριση επιπέδων: δημιουργία, μετονομασία, πάγωμα, κλείδωμα και απομόνωση. Ορίστε χρώμα, τύπο γραμμής και πάχος ανά επίπεδο. Όλα τα δεδομένα επιπέδου διατηρούνται στην εξαγωγή DXF.' },
        { q: 'Ποιοι τύποι διαστάσεων είναι διαθέσιμοι;', a: 'Γραμμικές, ευθυγραμμισμένες, ακτίνας, διαμέτρου, γωνιακές και συνεχόμενες διαστάσεις. Όλες αποθηκεύονται ως τυπικές οντότητες DXF DIMENSION.' },
        { q: 'Μπορώ να επεξεργαστώ γεωμετρία με λαβές;', a: 'Ναι. Επιλέξτε οποιαδήποτε οντότητα για να εμφανιστούν λαβές σε βασικά σημεία — τελικά σημεία, μέσα, κέντρα, άκρα τόξων. Σύρετε για αναμόρφωση ή πληκτρολογήστε τιμή ενώ σύρετε.' },
        { q: 'Υποστηρίζεται πραγματική συνεργασία;', a: 'Όχι προς το παρόν. Το KulmanLab είναι εργαλείο ενός χρήστη και τα σχέδια παραμένουν τοπικά. Ο συγχρονισμός cloud και η συνεργασία είναι εκτός του τρέχοντος πεδίου.' },
      ],
    },
    {
      headingKey: 'faq.section.compat',
      items: [
        { q: 'Είναι τα αρχεία DXF του KulmanLab συμβατά με άλλο λογισμικό CAD;', a: 'Ναι. Το KulmanLab διαβάζει και γράφει AC1032 DXF — μια ευρέως υποστηριζόμενη έκδοση. Τα αρχεία ανοίγουν σωστά στο LibreCAD, QCAD, BricsCAD, FreeCAD και οποιοδήποτε άλλο εργαλείο DXF.' },
        { q: 'Ποια είναι η διαφορά μεταξύ DXF και DWG;', a: 'Το DXF είναι μια ανοιχτή, βασισμένη σε κείμενο μορφή ανταλλαγής σχεδιασμένη για διαλειτουργικότητα. Το DWG είναι μια ιδιόκτητη δυαδική μορφή. Το KulmanLab χρησιμοποιεί DXF, το οποίο είναι αναγνώσιμο από σχεδόν κάθε εργαλείο CAD.' },
        { q: 'Μπορεί το KulmanLab να αντικαταστήσει το desktop CAD μου;', a: 'Για 2D σχεδίαση — ναι. Το KulmanLab έχει πλήρες terminal εντολών, επίπεδα, snapping, διαστάσεις, επεξεργασία με λαβές και συμβατότητα DXF. Δεν υποστηρίζει 3D, blocks/xrefs ή παραμετρικούς περιορισμούς.' },
      ],
    },
    {
      headingKey: 'faq.section.privacy',
      items: [
        ...
        { q: 'Χρησιμοποιούνται cookies;', a: 'Τα cookies χρησιμοποιούνται για το Google Analytics, το οποίο συλλέγει ανώνυμες μετρήσεις χρήσης (προβολές σελίδων, αριθμός συνεδριών).' },
      ],
    },
  ],
  pa: [
    {
      headingKey: 'faq.section.start',
      items: [
        { q: 'ਕੀ KulmanLab ਸੱਚਮੁੱਚ ਮੁਫ਼ਤ ਹੈ?', a: 'ਹਾਂ — ਪੂਰੀ ਤਰ੍ਹਾਂ ਮੁਫ਼ਤ। ਕੋਈ ਸਬਸਕ੍ਰਿਪਸ਼ਨ ਨਹੀਂ, ਕੋਈ ਕ੍ਰੈਡਿਟ ਕਾਰਡ ਨਹੀਂ, ਕੋਈ ਲੁਕਿਆ ਪਲਾਨ ਨਹੀਂ। ਪੂਰਾ ਫੀਚਰ ਸੈੱਟ ਹਰ ਕਿਸੇ ਲਈ ਬਿਨਾਂ ਕਿਸੇ ਸੀਮਾ ਦੇ ਉਪਲਬਧ ਹੈ।' },
        { q: 'ਕੀ ਮੈਨੂੰ ਖਾਤਾ ਬਣਾਉਣ ਦੀ ਲੋੜ ਹੈ?', a: 'ਨਹੀਂ। ਕੋਈ ਲੌਗਇਨ, ਸਾਈਨ-ਅੱਪ ਜਾਂ ਈਮੇਲ ਲੋੜੀਂਦਾ ਨਹੀਂ। ਐਪ ਖੋਲ੍ਹੋ ਅਤੇ ਤੁਰੰਤ ਬਣਾਉਣਾ ਸ਼ੁਰੂ ਕਰੋ।' },
        { q: 'ਕਿਹੜੇ ਬ੍ਰਾਊਜ਼ਰ ਸਪੋਰਟ ਕੀਤੇ ਜਾਂਦੇ ਹਨ?', a: 'ਕੋਈ ਵੀ ਆਧੁਨਿਕ ਡੈਸਕਟੌਪ ਬ੍ਰਾਊਜ਼ਰ — Chrome, Firefox, Safari ਅਤੇ Edge ਸਭ ਕੰਮ ਕਰਦੇ ਹਨ। KulmanLab ਸਿਰਫ਼ ਡੈਸਕਟੌਪ ਲਈ ਹੈ; ਮੋਬਾਈਲ ਅਤੇ ਟੈਬਲੈੱਟ ਫਿਲਹਾਲ ਸਪੋਰਟ ਨਹੀਂ ਕੀਤੇ ਜਾਂਦੇ।' },
        { q: 'ਕੀ ਇਹ ਆਫਲਾਈਨ ਕੰਮ ਕਰਦਾ ਹੈ?', a: 'ਹਾਂ। ਪਹਿਲੀ ਵਾਰ ਲੋਡ ਹੋਣ ਤੋਂ ਬਾਅਦ ਐਪ ਕੈਸ਼ ਹੋ ਜਾਂਦੀ ਹੈ ਅਤੇ ਇੰਟਰਨੈਟ ਕਨੈਕਸ਼ਨ ਤੋਂ ਬਿਨਾਂ ਪੂਰੀ ਤਰ੍ਹਾਂ ਚੱਲਦੀ ਹੈ। ਤੁਹਾਡੀਆਂ ਡਰਾਇੰਗਾਂ ਸਥਾਨਕ ਤੌਰ ਤੇ ਸੰਭਾਲੀਆਂ ਜਾਂਦੀਆਂ ਹਨ ਇਸ ਲਈ ਕਿਸੇ ਸਰਵਰ ਦੀ ਲੋੜ ਨਹੀਂ।' },
      ],
    },
    {
      headingKey: 'faq.section.files',
    ...
    },
    {
      headingKey: 'faq.section.features',
      items: [
        { q: 'ਕੀ ਇਸ ਵਿੱਚ ਕਮਾਂਡ ਟਰਮੀਨਲ ਹੈ?', a: 'ਹਾਂ। ਸਿੱਧੀਆਂ ਕਮਾਂਡਾਂ ਟਾਈਪ ਕਰੋ — LINE, CIRCLE, MOVE, TRIM ਅਤੇ 50+ ਹੋਰ। ਟਰਮੀਨਲ ਇਤਿਹਾਸ (ਐਰੋ ਕੀਜ਼), ਆਟੋਕੰਪਲੀਟ (Tab) ਅਤੇ ਸਟੀਕ ਨੰਬਰੀ ਇਨਪੁੱਟ ਸਪੋਰਟ ਕਰਦਾ ਹੈ।' },
        { q: 'ਕੀ ਲੇਅਰ ਸਪੋਰਟ ਹੈ?', a: 'ਪੂਰਾ ਲੇਅਰ ਪ੍ਰਬੰਧਨ: ਲੇਅਰ ਬਣਾਓ, ਨਾਮ ਬਦਲੋ, ਫ੍ਰੀਜ਼, ਲਾਕ ਅਤੇ ਆਈਸੋਲੇਟ ਕਰੋ। ਹਰੇਕ ਲੇਅਰ ਲਈ ਰੰਗ, ਲਾਈਨਟਾਈਪ ਅਤੇ ਲਾਈਨਵੇਟ ਸੈੱਟ ਕਰੋ। DXF ਐਕਸਪੋਰਟ ਵਿੱਚ ਸਾਰਾ ਲੇਅਰ ਡਾਟਾ ਸੁਰੱਖਿਅਤ ਰਹਿੰਦਾ ਹੈ।' },
        { q: 'ਕਿਸ ਤਰ੍ਹਾਂ ਦੇ ਮਾਪ ਉਪਲਬਧ ਹਨ?', a: 'ਲੀਨੀਅਰ, ਅਲਾਈਨਡ, ਰੇਡੀਅਸ, ਡਾਇਆਮੀਟਰ, ਐਂਗੁਲਰ ਅਤੇ ਕੰਟੀਨਿਊ ਮਾਪ। ਸਾਰੇ ਸਟੈਂਡਰਡ DXF DIMENSION ਐਂਟਿਟੀ ਵਜੋਂ ਸੰਭਾਲੇ ਜਾਂਦੇ ਹਨ ਜੋ ਹੋਰ DXF-ਸਮਰੱਥ CAD ਟੂਲਾਂ ਨਾਲ ਅਨੁਕੂਲ ਹਨ।' },
        { q: 'ਕੀ ਮੈਂ ਗ੍ਰਿਪਸ ਨਾਲ ਜਿਓਮੈਟਰੀ ਸੰਪਾਦਿਤ ਕਰ ਸਕਦਾ ਹਾਂ?', a: 'ਹਾਂ। ਕੋਈ ਵੀ ਐਂਟਿਟੀ ਚੁਣੋ ਅਤੇ ਮੁੱਖ ਪੁਆਇੰਟਾਂ ਉੱਤੇ ਗ੍ਰਿਪ ਹੈਂਡਲ ਦਿਖਾਈ ਦਿੰਦੇ ਹਨ — ਐਂਡਪੁਆਇੰਟ, ਮਿਡਪੁਆਇੰਟ, ਸੈਂਟਰ, ਆਰਕ ਐਂਡ। ਸਿੱਧਾ ਕੈਨਵਸ ਉੱਤੇ ਮੁੜ-ਆਕਾਰ ਦੇਣ ਲਈ ਖਿੱਚੋ, ਜਾਂ ਸਟੀਕ ਪਲੇਸਮੈਂਟ ਲਈ ਖਿੱਚਦੇ ਸਮੇਂ ਮੁੱਲ ਟਾਈਪ ਕਰੋ।' },
        { q: 'ਕੀ ਰੀਅਲ-ਟਾਈਮ ਸਹਿਯੋਗ ਸਪੋਰਟ ਹੈ?', a: 'ਅਜੇ ਨਹੀਂ। KulmanLab ਇੱਕ ਸਿੰਗਲ-ਯੂਜ਼ਰ ਟੂਲ ਹੈ ਅਤੇ ਡਰਾਇੰਗਾਂ ਸਥਾਨਕ ਤੌਰ ਤੇ ਰਹਿੰਦੀਆਂ ਹਨ। ਕਲਾਊਡ ਸਿੰਕ ਅਤੇ ਸਹਿਯੋਗ ਮੌਜੂਦਾ ਦਾਇਰੇ ਤੋਂ ਬਾਹਰ ਹਨ।' },
      ],
    },
    {
      headingKey: 'faq.section.compat',
      items: [
        { q: 'ਕੀ KulmanLab DXF ਫਾਈਲਾਂ ਹੋਰ CAD ਸਾਫਟਵੇਅਰ ਨਾਲ ਅਨੁਕੂਲ ਹਨ?', a: 'ਹਾਂ। KulmanLab AC1032 DXF ਪੜ੍ਹਦਾ ਅਤੇ ਲਿਖਦਾ ਹੈ — ਇੱਕ ਵਿਆਪਕ ਤੌਰ ਤੇ ਸਮਰਥਿਤ ਵਰਜ਼ਨ। ਫਾਈਲਾਂ LibreCAD, QCAD, BricsCAD, FreeCAD ਅਤੇ ਕਿਸੇ ਵੀ ਹੋਰ DXF-ਸਮਰੱਥ ਟੂਲ ਵਿੱਚ ਸਹੀ ਢੰਗ ਨਾਲ ਖੁੱਲ੍ਹਦੀਆਂ ਹਨ।' },
        { q: 'DXF ਅਤੇ DWG ਵਿੱਚ ਕੀ ਫਰਕ ਹੈ?', a: 'DXF ਇੱਕ ਖੁੱਲ੍ਹਾ, ਟੈਕਸਟ-ਅਧਾਰਤ ਵਟਾਂਦਰਾ ਫਾਰਮੈਟ ਹੈ ਜੋ ਇੰਟਰਓਪਰੇਬਿਲਟੀ ਲਈ ਡਿਜ਼ਾਈਨ ਕੀਤਾ ਗਿਆ ਹੈ। DWG ਇੱਕ ਮਲਕੀਅਤੀ ਬਾਈਨਰੀ ਫਾਰਮੈਟ ਹੈ। KulmanLab DXF ਵਰਤਦਾ ਹੈ, ਜੋ ਲਗਭਗ ਹਰ CAD ਟੂਲ ਦੁਆਰਾ ਪੜ੍ਹਨਯੋਗ ਹੈ।' },
        { q: 'ਕੀ KulmanLab ਮੇਰੇ ਡੈਸਕਟੌਪ CAD ਸਾਫਟਵੇਅਰ ਦੀ ਥਾਂ ਲੈ ਸਕਦਾ ਹੈ?', a: '2D ਡਰਾਫਟਿੰਗ ਲਈ — ਹਾਂ। KulmanLab ਵਿੱਚ ਪੂਰਾ ਕਮਾਂਡ ਟਰਮੀਨਲ, ਲੇਅਰ, ਸਨੈਪਿੰਗ, ਮਾਪ, ਗ੍ਰਿਪ ਐਡੀਟਿੰਗ ਅਤੇ DXF ਅਨੁਕੂਲਤਾ ਹੈ। ਇਹ 3D, ਬਲਾਕ/xref ਜਾਂ ਪੈਰਾਮੈਟ੍ਰਿਕ ਕੰਸਟ੍ਰੇਂਟ ਸਪੋਰਟ ਨਹੀਂ ਕਰਦਾ।' },
      ],
    },
    {
      headingKey: 'faq.section.privacy',
      items: [
        ...
        { q: 'ਕੀ ਕੂਕੀਜ਼ ਵਰਤੀਆਂ ਜਾਂਦੀਆਂ ਹਨ?', a: 'ਕੂਕੀਜ਼ Google Analytics ਲਈ ਵਰਤੀਆਂ ਜਾਂਦੀਆਂ ਹਨ, ਜੋ ਗੁਮਨਾਮ ਵਰਤੋਂ ਮੈਟ੍ਰਿਕਸ (ਪੇਜ ਵਿਊ, ਸੈਸ਼ਨ ਗਿਣਤੀ) ਇਕੱਠਾ ਕਰਦਾ ਹੈ।' },
      ],
    },
  ],
  sv: [
    {
      headingKey: 'faq.section.start',
      items: [
        { q: 'Är KulmanLab verkligen gratis?', a: 'Ja — helt gratis. Ingen prenumeration, inget kreditkort, inga dolda planer. Hela funktionsuppsättningen är tillgänglig för alla utan begränsningar.' },
        { q: 'Måste jag skapa ett konto?', a: 'Nej. Ingen inloggning, registrering eller e-post krävs. Öppna appen och börja rita direkt.' },
        { q: 'Vilka webbläsare stöds?', a: 'Vilken modern skrivbordswebbläsare som helst — Chrome, Firefox, Safari och Edge fungerar alla. KulmanLab är bara för skrivbordet; mobil och surfplatta stöds för närvarande inte.' },
        { q: 'Fungerar det offline?', a: 'Ja. Efter den första laddningen cachas appen och körs helt utan internetanslutning. Dina ritningar sparas lokalt så ingen server behövs.' },
      ],
    },
    {
      headingKey: 'faq.section.files',
    ...
    },
    {
      headingKey: 'faq.section.features',
      items: [
        { q: 'Har den en kommandoterminal?', a: 'Ja. Skriv kommandon direkt — LINE, CIRCLE, MOVE, TRIM och 50+ till. Terminalen stödjer historik (piltangenter), autokomplettering (Tab) och exakt numerisk inmatning.' },
        { q: 'Finns lagerstöd?', a: 'Full lagerhantering: skapa, byt namn på, frys, lås och isolera lager. Ställ in färg, linjetyp och linjevikt för varje lager. All lagerdata bevaras vid DXF-export.' },
        { q: 'Vilka typer av måttsättning finns?', a: 'Linjär, justerad, radie, diameter, vinkel och fortsatt måttsättning. Alla sparas som standard DXF DIMENSION-objekt som är kompatibla med andra DXF-kapabla CAD-verktyg.' },
        { q: 'Kan jag redigera geometri med handtag?', a: 'Ja. Välj valfritt objekt och handtag visas vid viktiga punkter — ändpunkt, mittpunkt, centrum, bågände. Dra för att omforma direkt på ritytan, eller skriv in ett värde medan du drar för exakt placering.' },
        { q: 'Stöds realtidssamarbete?', a: 'Inte ännu. KulmanLab är ett verktyg för en användare och ritningar sparas lokalt. Molnsynkronisering och samarbete ligger utanför nuvarande omfattning.' },
      ],
    },
    {
      headingKey: 'faq.section.compat',
      items: [
        { q: 'Är KulmanLabs DXF-filer kompatibla med annan CAD-programvara?', a: 'Ja. KulmanLab läser och skriver AC1032 DXF — en allmänt stödd version. Filer öppnas korrekt i LibreCAD, QCAD, BricsCAD, FreeCAD och alla andra DXF-kapabla verktyg.' },
        { q: 'Vad är skillnaden mellan DXF och DWG?', a: 'DXF är ett öppet, textbaserat utbytesformat designat för interoperabilitet. DWG är ett proprietärt binärformat. KulmanLab använder DXF, som kan läsas av nästan alla CAD-verktyg.' },
        { q: 'Kan KulmanLab ersätta min skrivbords-CAD-programvara?', a: 'För 2D-ritning — ja. KulmanLab har en fullständig kommandoterminal, lager, fångst, måttsättning, handtagsredigering och DXF-kompatibilitet. Den stödjer inte 3D, block/xref eller parametriska begränsningar.' },
      ],
    },
    {
      headingKey: 'faq.section.privacy',
      items: [
        ...
        { q: 'Används cookies?', a: 'Cookies används för Google Analytics, som samlar in anonym användningsstatistik (sidvisningar, antal sessioner).' },
      ],
    },
  ],
  tl: [
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'May ginagamit bang cookies?', a: 'Ginagamit ang cookies para sa Google Analytics, na nangongolekta ng anonymous na usage metrics (page views, bilang ng session).' },
      ],
    },
  ],
  ...
  he: [
    {
      headingKey: 'faq.section.start',
      items: [
        { q: 'האם KulmanLab באמת חינמי?', a: 'כן — חינמי לחלוטין. ללא מנוי, ללא כרטיס אשראי, ללא תוכנית נסתרת. מלוא היכולות זמינות לכולם ללא הגבלה.' },
        { q: 'האם עליי ליצור חשבון?', a: 'לא. אין התחברות, אין הרשמה ואין צורך באימייל. פתחו את האפליקציה והתחילו לשרטט מיד.' },
        { q: 'אילו דפדפנים נתמכים?', a: 'כל דפדפן שולחני מודרני — Chrome, Firefox, Safari ו-Edge פועלים כולם. KulmanLab מיועד לשולחן העבודה בלבד; מובייל וטאבלט אינם נתמכים כרגע.' },
        { q: 'האם זה עובד אופליין?', a: 'כן. לאחר הטעינה הראשונה האפליקציה נשמרת במטמון ופועלת לחלוטין ללא חיבור לאינטרנט. השרטוטים שלכם נשמרים מקומית כך שאין צורך בשרת.' },
      ],
    },
    {
      headingKey: 'faq.section.files',
      items: [
        { q: 'היכן נשמרים השרטוטים שלי?', a: 'ב-IndexedDB של הדפדפן שלכם — על המכשיר שלכם. שום דבר לעולם לא מועלה לשרת. לכל דפדפן בכל מכשיר יש אחסון עצמאי משלו.' },
        { q: 'מה קורה אם אני מנקה את נתוני הדפדפן שלי?', a: 'השרטוטים השמורים שלכם יאבדו. תמיד ייצאו עותק JSON של כל דבר חשוב לפני ניקוי אחסון הדפדפן.' },
        { q: 'האם אני יכול לפתוח קבצי ‎.dwg?', a: 'KulmanLab תומך ב-DXF ‏(Drawing Exchange Format), לא בפורמט הקנייני DWG. רוב יישומי ה-CAD השולחניים יכולים לייצא DXF, כך שייצאו מהיישום המקורי שלכם תחילה.' },
        { q: 'אילו פורמטים לייצוא זמינים?', a: 'DXF ו-JSON דרך Export — DXF להעברה הדדית עם כלי CAD אחרים, JSON לשמירה מלאה (כולל מידות וחיצי הפניה) בתוך KulmanLab. Print מייצא בנפרד תמונות PNG, JPEG, WebP או PDF, עם אפשרות לחיתוך אזור ומצב שחור-לבן.' },
      ],
    },
    {
      headingKey: 'faq.section.features',
      items: [
        { q: 'האם יש מסוף פקודות?', a: 'כן. הקלידו פקודות ישירות — LINE, CIRCLE, MOVE, TRIM ועוד למעלה מ-50. המסוף תומך בהיסטוריה (מקשי חיצים), השלמה אוטומטית (Tab) והזנה מספרית מדויקת.' },
        { q: 'האם יש תמיכה בשכבות?', a: 'ניהול שכבות מלא: יצירה, שינוי שם, הקפאה, נעילה ובידוד שכבות. הגדרת צבע, סוג קו ועובי קו לכל שכבה. כל נתוני השכבות נשמרים בייצוא DXF.' },
        { q: 'אילו סוגי מידות זמינים?', a: 'מידות ליניאריות, מיושרות, רדיוס, קוטר, זוויתיות ורציפות. הכל נשמר כישויות DIMENSION תקניות של DXF, תואמות לכלי CAD אחרים התומכים ב-DXF.' },
        { q: 'האם ניתן לערוך גיאומטריה באמצעות נקודות אחיזה?', a: 'כן. בחרו כל ישות כדי לחשוף נקודות אחיזה בנקודות מפתח — קצוות, אמצעים, מרכזים, קצוות קשת. גררו לעיצוב מחדש ישירות על הקנבס, או הקלידו ערך תוך כדי גרירה למיקום מדויק.' },
        { q: 'האם נתמכת שיתופיות בזמן אמת?', a: 'לא כרגע. KulmanLab הוא כלי למשתמש יחיד והשרטוטים נשארים מקומיים. סנכרון ענן ושיתופיות אינם בהיקף הנוכחי.' },
      ],
    },
    {
      headingKey: 'faq.section.compat',
      items: [
        { q: 'האם קבצי DXF של KulmanLab תואמים לתוכנות CAD אחרות?', a: 'כן. KulmanLab קורא וכותב DXF בגרסת AC1032 — גרסה נתמכת באופן נרחב. הקבצים נפתחים כראוי ב-LibreCAD, QCAD, BricsCAD, FreeCAD וכל כלי אחר התומך ב-DXF.' },
        { q: 'מה ההבדל בין DXF ל-DWG?', a: 'DXF הוא פורמט חילופין פתוח ומבוסס טקסט, שנועד לאינטראופרביליות. DWG הוא פורמט בינארי קנייני. KulmanLab משתמש ב-DXF, שניתן לקריאה כמעט בכל כלי CAD.' },
        { q: 'האם KulmanLab יכול להחליף את תוכנת ה-CAD השולחנית שלי?', a: 'לשרטוט דו-ממדי — כן. ל-KulmanLab יש מסוף פקודות מלא, שכבות, הצמדה, מידות, עריכת נקודות אחיזה ותאימות DXF. הוא אינו תומך בתלת-ממד, בלוקים/הפניות חיצוניות (xrefs) או אילוצים פרמטריים.' },
      ],
    },
    {
      headingKey: 'faq.section.privacy',
      items: [
        { q: 'האם KulmanLab אוסף את נתוני השרטוט שלי?', a: 'לא. השרטוטים שלכם נשארים בדפדפן שלכם ולעולם לא נשלחים לשום מקום. KulmanLab משתמש ב-Google Analytics למדדי שימוש אנונימיים (צפיות בדפים, ספירת הפעלות) — אין מעורבות של תוכן שרטוט.' },
        { q: 'האם נעשה שימוש בעוגיות?', a: 'עוגיות משמשות עבור Google Analytics, שאוסף מדדי שימוש אנונימיים (צפיות בדפים, ספירת הפעלות).' },
      ],
    },
  ],
