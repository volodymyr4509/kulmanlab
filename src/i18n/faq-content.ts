  ...
  ur: [
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'کون سے برآمد فارمیٹس دستیاب ہیں؟', a: 'دوسرے CAD ٹولز کے ساتھ ہم آہنگی کے لیے DXF، اور پرنٹ کے لیے تیار آؤٹ پٹ کے لیے PDF یا PNG/WebP۔ پرنٹ مینیجر برآمد سے پہلے DPI اور کاغذ کا سائز ترتیب دینے کی اجازت دیتا ہے۔' },
      ],
    },
    {
      headingKey: 'faq.section.features',
  ...
  el: [
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Ποιες μορφές εξαγωγής είναι διαθέσιμες;', a: 'DXF για ανταλλαγή με άλλα εργαλεία CAD, και PDF ή PNG/WebP για εκτύπωσιμη έξοδο. Ο διαχειριστής εκτύπωσης σας επιτρέπει να ορίσετε DPI και μέγεθος χαρτιού.' },
      ],
    },
    {
      headingKey: 'faq.section.features',
  ...
  pa: [
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'ਕਿਹੜੇ ਐਕਸਪੋਰਟ ਫਾਰਮੈਟ ਉਪਲਬਧ ਹਨ?', a: 'ਹੋਰ CAD ਟੂਲਾਂ ਨਾਲ ਵਟਾਂਦਰੇ ਲਈ DXF, ਅਤੇ ਪ੍ਰਿੰਟ-ਰੈਡੀ ਆਉਟਪੁੱਟ ਲਈ PDF ਜਾਂ PNG/WebP। ਪ੍ਰਿੰਟ ਮੈਨੇਜਰ ਐਕਸਪੋਰਟ ਤੋਂ ਪਹਿਲਾਂ DPI ਅਤੇ ਪੇਪਰ ਸਾਈਜ਼ ਸੈੱਟ ਕਰਨ ਦਿੰਦਾ ਹੈ।' },
      ],
    },
    {
      headingKey: 'faq.section.features',
  ...
  sv: [
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Vilka exportformat är tillgängliga?', a: 'DXF för utbyte med andra CAD-verktyg, samt PDF eller PNG/WebP för utskriftsklar utdata. Utskriftshanteraren låter dig ställa in DPI och pappersstorlek innan export.' },
      ],
    },
    {
      headingKey: 'faq.section.features',
