  ...
  en: {
    ...
    guides: [
      ...
      },
      {
        ...
        steps: [
          'Place a new text label (<code>text</code> command) or double-click an existing Text or Multileader to open the text editor.',
          'Click the <strong>Font Manager</strong> button in the text editor toolbar, or type <code>FontManager</code> in the terminal.',
  ...
  de: {
    ...
    guides: [
      ...
      },
      {
        ...
        steps: [
          'Platzieren Sie eine neue Textbeschriftung (Befehl <code>text</code>) oder doppelklicken Sie auf einen vorhandenen Text oder Multileader, um den Texteditor zu öffnen.',
          'Klicken Sie auf die Schaltfläche <strong>Font Manager</strong> in der Symbolleiste des Texteditors, oder geben Sie <code>FontManager</code> im Terminal ein.',
  ...
  es: {
    ...
    guides: [
      ...
      },
      {
        ...
        steps: [
          'Coloca una nueva etiqueta de texto (comando <code>text</code>) o haz doble clic en un Text o Multileader existente para abrir el editor de texto.',
          'Haz clic en el botón <strong>Font Manager</strong> de la barra de herramientas del editor de texto, o escribe <code>FontManager</code> en el terminal.',
  ...
  fr: {
    ...
    guides: [
      ...
      },
      {
        ...
        steps: [
          'Placez un nouveau label de texte (commande <code>text</code>) ou double-cliquez sur un Text ou Multileader existant pour ouvrir l\'éditeur de texte.',
          'Cliquez sur le bouton <strong>Font Manager</strong> dans la barre d\'outils de l\'éditeur de texte, ou tapez <code>FontManager</code> dans le terminal.',
  ...
  it: {
    ...
    guides: [
      ...
      },
      {
        ...
        steps: [
          'Posiziona una nuova etichetta di testo (comando <code>text</code>) o fai doppio clic su un Text o Multileader esistente per aprire l\'editor di testo.',
          'Clicca il pulsante <strong>Font Manager</strong> nella barra degli strumenti dell\'editor di testo, oppure digita <code>FontManager</code> nel terminale.',
  ...
  pt: {
    ...
    guides: [
      ...
      },
      {
        ...
        steps: [
          'Coloque uma nova etiqueta de texto (comando <code>text</code>) ou clique duas vezes em um Text ou Multileader existente para abrir o editor de texto.',
          'Clique no botão <strong>Font Manager</strong> na barra de ferramentas do editor de texto, ou digite <code>FontManager</code> no terminal.',
  ...
  uk: {
    ...
    guides: [
      ...
      },
      {
        ...
        steps: [
          'Розмістіть нову текстову мітку (команда <code>text</code>) або двічі клацніть на наявному Text чи Multileader, щоб відкрити текстовий редактор.',
          'Натисніть кнопку <strong>Font Manager</strong> на панелі інструментів текстового редактора, або введіть <code>FontManager</code> у терміналі.',
  ...
  tr: {
    ...
    guides: [
      ...
      },
      {
        ...
        steps: [
          'Yeni bir metin etiketi yerleştirin (<code>text</code> komutu) veya metin düzenleyiciyi açmak için mevcut bir Text ya da Multileader\'a çift tıklayın.',
          'Metin düzenleyici araç çubuğundaki <strong>Font Manager</strong> düğmesine tıklayın veya terminale <code>FontManager</code> yazın.',
  ...
  zh: {
    ...
    guides: [
      ...
      },
      {
        ...
        steps: [
          '放置一个新的文字标签（<code>text</code> 命令），或双击现有的 Text 或 Multileader 以打开文字编辑器。',
          '单击文字编辑器工具栏中的 <strong>Font Manager</strong> 按钮，或在命令行中输入 <code>FontManager</code>。',
  ...
  hi: {
    ...
    guides: [
      ...
      },
      {
        ...
        steps: [
          'एक नया टेक्स्ट लेबल रखें (<code>text</code> कमांड) या टेक्स्ट एडिटर खोलने के लिए किसी मौजूदा Text या Multileader पर डबल-क्लिक करें।',
          'टेक्स्ट एडिटर टूलबार में <strong>Font Manager</strong> बटन पर क्लिक करें, या टर्मिनल में <code>FontManager</code> टाइप करें।',
  ...
  ar: {
    ...
    guides: [
      ...
      },
      {
        ...
        steps: [
          'ضع تسمية نص جديدة (أمر <code>text</code>) أو انقر نقراً مزدوجاً على Text أو Multileader موجود لفتح محرر النص.',
          'انقر على زر <strong>Font Manager</strong> في شريط أدوات محرر النص، أو اكتب <code>FontManager</code> في المحطة.',
  ...
  id: {
    ...
    guides: [
      ...
      },
      {
        ...
        steps: [
          'Tempatkan label teks baru (perintah <code>text</code>) atau klik dua kali pada Text atau Multileader yang ada untuk membuka text editor.',
          'Klik tombol <strong>Font Manager</strong> di toolbar text editor, atau ketik <code>FontManager</code> di terminal.',
  ...
  ja: {
    ...
    guides: [
      ...
      },
      {
        ...
        steps: [
          '新しいテキストラベルを配置する（<code>text</code> コマンド）か、既存の Text または Multileader をダブルクリックしてテキストエディターを開きます。',
          'テキストエディターのツールバーにある <strong>Font Manager</strong> ボタンをクリックするか、ターミナルに <code>FontManager</code> と入力します。',
  ...
  pl: {
    ...
    guides: [
      ...
      },
      {
        ...
        steps: [
          'Umieść nową etykietę tekstową (polecenie <code>text</code>) lub kliknij dwukrotnie istniejący Text bądź Multileader, aby otworzyć edytor tekstu.',
          'Kliknij przycisk <strong>Font Manager</strong> na pasku narzędzi edytora tekstu lub wpisz <code>FontManager</code> w terminalu.',
  ...
  ko: {
    ...
    guides: [
      ...
      },
      {
        ...
        steps: [
          '새 텍스트 레이블을 배치하거나(<code>text</code> 명령어) 기존 Text 또는 Multileader를 더블클릭하여 텍스트 편집기를 엽니다.',
          '텍스트 편집기 도구 모음에서 <strong>Font Manager</strong> 버튼을 클릭하거나 터미널에 <code>FontManager</code>를 입력합니다.',
  ...
  vi: {
    ...
    guides: [
      ...
      },
      {
        ...
        steps: [
          'Đặt một nhãn văn bản mới (lệnh <code>text</code>) hoặc nhấp đúp vào một Text hoặc Multileader hiện có để mở trình soạn thảo văn bản.',
          'Nhấp nút <strong>Font Manager</strong> trên thanh công cụ trình soạn thảo văn bản, hoặc gõ <code>FontManager</code> trong terminal.',
  ...
  th: {
    ...
    guides: [
      ...
      },
      {
        ...
        steps: [
          'วางป้ายข้อความใหม่ (คำสั่ง <code>text</code>) หรือดับเบิลคลิกที่ Text หรือ Multileader ที่มีอยู่เพื่อเปิด text editor',
          'คลิกปุ่ม <strong>Font Manager</strong> บนแถบเครื่องมือของ text editor หรือพิมพ์ <code>FontManager</code> ในเทอร์มินัล',
  ...
  ms: {
    ...
    guides: [
      ...
      },
      {
        ...
        steps: [
          'Letakkan label teks baharu (arahan <code>text</code>) atau klik dua kali pada Text atau Multileader sedia ada untuk membuka text editor.',
          'Klik butang <strong>Font Manager</strong> pada bar alat text editor, atau taip <code>FontManager</code> dalam terminal.',
  ...
  bn: {
    ...
    guides: [
      ...
      },
      {
        ...
        steps: [
          'একটি নতুন টেক্সট লেবেল স্থাপন করুন (<code>text</code> কমান্ড) অথবা টেক্সট এডিটর খুলতে বিদ্যমান কোনো Text বা Multileader-এ ডাবল-ক্লিক করুন।',
          'টেক্সট এডিটর টুলবারে <strong>Font Manager</strong> বাটনে ক্লিক করুন, অথবা টার্মিনালে <code>FontManager</code> টাইপ করুন।',
  ...
  sw: {
    ...
    guides: [
      ...
      },
      {
        ...
        steps: [
          'Weka lebo mpya ya maandishi (amri ya <code>text</code>) au bofya mara mbili Text au Multileader iliyopo ili kufungua text editor.',
          'Bofya kitufe cha <strong>Font Manager</strong> kwenye upau wa zana wa text editor, au andika <code>FontManager</code> kwenye terminal.',
  ...
  ur: {
    ...
    guides: [
      ...
      },
      {
        ...
        steps: [
          'ایک نیا ٹیکسٹ لیبل رکھیں (<code>text</code> کمانڈ) یا موجودہ Text یا Multileader پر ڈبل کلک کر کے text editor کھولیں۔',
          'text editor ٹول بار میں <strong>Font Manager</strong> بٹن پر کلک کریں، یا ٹرمینل میں <code>FontManager</code> ٹائپ کریں۔',
  ...
  el: {
    ...
    guides: [
      ...
      },
      {
        ...
        steps: [
          'Τοποθετήστε μια νέα ετικέτα κειμένου (εντολή <code>text</code>) ή κάντε διπλό κλικ σε ένα υπάρχον Text ή Multileader για να ανοίξετε τον επεξεργαστή κειμένου.',
          'Κάντε κλικ στο κουμπί <strong>Font Manager</strong> στη γραμμή εργαλείων του επεξεργαστή κειμένου, ή πληκτρολογήστε <code>FontManager</code> στο τερματικό.',
  ...
  pa: {
    ...
    guides: [
      ...
      },
      {
        ...
        steps: [
          'ਇੱਕ ਨਵਾਂ ਟੈਕਸਟ ਲੇਬਲ ਰੱਖੋ (<code>text</code> ਕਮਾਂਡ) ਜਾਂ ਟੈਕਸਟ ਐਡੀਟਰ ਖੋਲ੍ਹਣ ਲਈ ਮੌਜੂਦਾ Text ਜਾਂ Multileader ਉੱਤੇ ਡਬਲ-ਕਲਿੱਕ ਕਰੋ।',
          'ਟੈਕਸਟ ਐਡੀਟਰ ਟੂਲਬਾਰ ਵਿੱਚ <strong>Font Manager</strong> ਬਟਨ ਉੱਤੇ ਕਲਿੱਕ ਕਰੋ, ਜਾਂ ਟਰਮੀਨਲ ਵਿੱਚ <code>FontManager</code> ਟਾਈਪ ਕਰੋ।',
  ...
  sv: {
    ...
    guides: [
      ...
      },
      {
        ...
        steps: [
          'Placera en ny textetikett (kommandot <code>text</code>) eller dubbelklicka på en befintlig Text eller Multileader för att öppna texteditorn.',
          'Klicka på knappen <strong>Font Manager</strong> i texteditorns verktygsfält, eller skriv <code>FontManager</code> i terminalen.',
  ...
  tl: {
    ...
    guides: [
      ...
      },
      {
        ...
        steps: [
          'Maglagay ng bagong text label (<code>text</code> command) o i-double-click ang isang umiiral na Text o Multileader para buksan ang text editor.',
          'I-click ang <strong>Font Manager</strong> button sa toolbar ng text editor, o i-type ang <code>FontManager</code> sa terminal.',
  ...
  nl: {
    ...
    guides: [
      ...
      },
      {
        ...
        steps: [
          'Plaats een nieuw tekstlabel (<code>text</code>-commando) of dubbelklik op een bestaande Text of Multileader om de teksteditor te openen.',
          'Klik op de knop <strong>Font Manager</strong> in de werkbalk van de teksteditor, of typ <code>FontManager</code> in de terminal.',
  ...
  he: {
    ...
    guides: [
      ...
      },
      {
        ...
        steps: [
          'הציבו תווית טקסט חדשה (פקודת <code>text</code>) או לחצו לחיצה כפולה על Text או Multileader קיימים כדי לפתוח את עורך הטקסט.',
          'לחצו על כפתור <strong>Font Manager</strong> בסרגל הכלים של עורך הטקסט, או הקלידו <code>FontManager</code> במסוף.',
  ...
  ha: {
    ...
    guides: [
      ...
      },
      {
        ...
        steps: [
          'Sanya sabon alamar rubutu (umarnin <code>text</code>) ko danna sau biyu a kan Text ko Multileader da ke akwai don buɗe naʼurar gyaran rubutu.',
          'Danna maɓallin <strong>Font Manager</strong> a kayan aiki na naʼurar gyaran rubutu, ko rubuta <code>FontManager</code> a tashar umarni.',
