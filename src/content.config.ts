...
const docsHa = defineCollection({
  loader: glob({ pattern: '**/*.md', base: './src/content/docs-ha' }),
  schema: docSchema,
});

const docsNo = defineCollection({
  loader: glob({ pattern: '**/*.md', base: './src/content/docs-no' }),
  schema: docSchema,
});
